...
function sum(a, b) {
     //eslint-disable-line
    var sumValues = a+b;
    return [sumValues,`The sum of 4 and 7 is 11.`];
}
...
Write a function called sumAndMultiply() that takes in three numbers as separate arguments and returns an array
 ...
 the second element is the product of those three numbers, 
  and the third and fourth elements are strings that EXACTLY 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    return [sumResult,productResult,'4 and 7 and 5 sum to 16.','The product of 4 and 7 and 5 is 140.'];
}
...
function sumArray(testArray) { //eslint-disable-line
    ...
    var sumValues = sum(sum(testArray[0],testArray[1])[0],testArray[2])[0];
    return[sumValues,'2,3,4 was passed in as an array of numbers, and 9 is their sum.'];
}
...
whose first element is the product of those numbers, and the second element is a string that EXACTLY follows this example
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    var finalMultibly = multiply(multiply(testArray[0],testArray[1])[0],testArray[2])[0];

    return [finalMultibly,'The numbers 2,3,4 have a product of 24.'];
